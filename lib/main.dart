  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
          apiKey: "AIzaSyAjc7EjBg2j6GojkM3ZTlUwKn70qlTVJTk",
          appId: "1:247312041321:web:323cfde1746c3d8eb429f8",
          messagingSenderId: "247312041321",
          storageBucket: "beacon-5c9ca.appspot.com",
          projectId: "beacon-5c9ca"),
    );
  } else {
    //
    await Firebase.initializeApp();
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        title: 'Beacon',
        theme: ThemeData(
          scaffoldBackgroundColor: const Color.fromARGB(255, 255, 238, 50),
        ),
        home: StreamBuilder(
